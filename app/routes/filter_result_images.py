...
@router.get("/filter_result_images/{filename}")
async def filter_result_images(filename: str):
    """
    An asynchronous script for searching and retrieving results from an image analysis file.
    ...
    Parameters:
    - filename (str): The filename (excluding "output_") of the image analysis file to search for.
    ...
    try:
        ...
        folder_path = settings.storage_url + 'results_images'
